...
class Config:
    APP_NAME = os.environ.get("APP_NAME", "Securado Compliance Hub")
    ...
    DOC_LINK = os.environ.get("DOC_LINK", "https://github.com/ktkdaskrishna/ISO")
    CONSOLE_LINK = os.environ.get("CONSOLE_LINK", "https://github.com/ktkdaskrishna/ISO")
